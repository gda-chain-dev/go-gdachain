...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for gdaSubscribe requests
}
...
// gdaSubscribe registers a subscripion under the "gda" namespace.
func (c *Client) gdaSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "gda", channel, args...)
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. gdaSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through gdaSubscribe.
