...
// Syncing provides information when this nodes starts synchronising with the gdachain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  gdaereum.SyncProgress `json:"status"`
}
