...
type downloadTester struct {
	...
	stateDb gdadb.Database // Database used by the tester for syncing from peers
	peerDb  gdadb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = gdadb.NewMemDatabase()
