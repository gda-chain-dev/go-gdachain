...
func TesgdaatusMsgErrors62(t *testing.T) { tesgdaatusMsgErrors(t, 62) }
func TesgdaatusMsgErrors63(t *testing.T) { tesgdaatusMsgErrors(t, 63) }

func tesgdaatusMsgErrors(t *testing.T, protocol int) {
