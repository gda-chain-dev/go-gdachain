...
//
// https://github.com/gdaereum/wiki/wiki/JSON-RPC#eth_newpendingtransactionfilter
...
//
// https://github.com/gdaereum/wiki/wiki/JSON-RPC#eth_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(gdaereum.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
//
// https://github.com/gdaereum/wiki/wiki/JSON-RPC#eth_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(gdaereum.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/gdaereum/wiki/wiki/JSON-RPC#eth_uninstallfilter
...
//
// https://github.com/gdaereum/wiki/wiki/JSON-RPC#eth_getfilterlogs
...
//
// https://github.com/gdaereum/wiki/wiki/JSON-RPC#eth_getfilterchanges
