...
func init() {
	...
	if runtime.GOOS == "windows" {
		DefaultConfig.gdaash.DatasetDir = filepath.Join(home, "AppData", "gdaash")
	} else {
		DefaultConfig.gdaash.DatasetDir = filepath.Join(home, ".ethash")
	}
}
...
type Config struct {
	...
	// If nil, the gdachain main net block is used.
