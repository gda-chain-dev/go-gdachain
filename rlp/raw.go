...
// not verify whgdaer the content of RawValues is valid RLP.
type RawValue []byte
...
// Spligdaring splits b into the content of an RLP string
// and any remaining bytes after the string.
func Spligdaring(b []byte) (content, rest []byte, err error) {
