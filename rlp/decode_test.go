...
func TesgdareamKind(t *testing.T) {
	tests := []struct {
		input    string
		wantKind Kind
		wantLen  uint64
...
func TestNewLisgdaream(t *testing.T) {
	ls := NewLisgdaream(bytes.NewReader(unhex("0101010101")), 3)
...
func TesgdareamErrors(t *testing.T) {
...
func TesgdareamList(t *testing.T) {
...
func TesgdareamRaw(t *testing.T) {
	tests := []struct {
		input  string
		output string
	}{
