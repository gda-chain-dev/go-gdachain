...
func NewLesOdr(db gdadb.Database, chtIndexer, bloomTrieIndexer, bloomIndexer *core.ChainIndexer, retriever *retrieveManager) *LesOdr {
	return &LesOdr{
		db:               db,
...
func (odr *LesOdr) Database() gdadb.Database {
	return odr.db
}
