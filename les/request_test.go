...
type accessTestFn func(db gdadb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db gdadb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db gdadb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db gdadb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db gdadb.Database, bhash common.Hash, number uint64) light.OdrRequest {
