...
type ChainConfig struct {
	...
	DAOForkSupport bool     `json:"daoForkSupport,omitempty"` // Whgdaer the nodes supports or opposes the DAO hard-fork

	// EIP150 implements the Gas price changes (https://github.com/gdaereum/EIPs/issues/150)
...
type gdaashConfig struct{}

// String implements the stringer interface, returning the consensus engine details.
func (c *gdaashConfig) String() string {
	return "ethash"
}
...
// IsHomestead returns whgdaer num is either equal to the homestead block or greater.
func (c *ChainConfig) IsHomestead(num *big.Int) bool {
	return isForked(c.HomesteadBlock, num)
}

// IsDAO returns whgdaer num is either equal to the DAO fork block or greater.
...
// isForked returns whgdaer a fork scheduled at block s is active at the given head block.
