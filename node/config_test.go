...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ggda.ipc", false, filepath.Join(os.TempDir(), "ggda.ipc")},
		{"data", "ggda.ipc", false, "data/ggda.ipc"},
		{"data", "./ggda.ipc", false, "./ggda.ipc"},
		{"data", "/ggda.ipc", false, "/ggda.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ggda.ipc", true, `\\.\pipe\ggda.ipc`},
		{"data", "ggda.ipc", true, `\\.\pipe\ggda.ipc`},
		{"data", `\\.\pipe\ggda.ipc`, true, `\\.\pipe\ggda.ipc`},
	}
