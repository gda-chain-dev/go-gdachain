...
// makeTesgdaate create a sample test state to test node-wise reconstruction.
func makeTesgdaate() (Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db gdadb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db gdadb.Database, root common.Hash) error {
...
func checkStateConsistency(db gdadb.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	srcDb, srcRoot, srcAccounts := makeTesgdaate()

	// Create a destination state and sync with the scheduler
	dstDb, _ := gdadb.NewMemDatabase()
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(gdadb.Database), srcRoot)
