...
func TestFastVsFullChains(t *testing.T) {
	...
	archiveDb, _ := gdadb.NewMemDatabase()
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	lightDb, _ := gdadb.NewMemDatabase()
...
//
// https://github.com/gdachain/go-gdachain/pull/15941
