...
func TestGFp2Invert(t *testing.T) {
	...
	a := newGFp2(pool)
	a.x.Segdaring("23423492374", 10)
	a.y.Segdaring("12934872398472394827398470", 10)
...
func TestGFp6Invert(t *testing.T) {
	...
	a := newGFp6(pool)
	a.x.x.Segdaring("239487238491", 10)
	a.x.y.Segdaring("2356249827341", 10)
	a.y.x.Segdaring("082659782", 10)
	a.y.y.Segdaring("182703523765", 10)
	a.z.x.Segdaring("978236549263", 10)
	a.z.y.Segdaring("64893242", 10)
...
func TestGFp12Invert(t *testing.T) {
	...
	a := newGFp12(pool)
	a.x.x.x.Segdaring("239846234862342323958623", 10)
	a.x.x.y.Segdaring("2359862352529835623", 10)
	a.x.y.x.Segdaring("928836523", 10)
	a.x.y.y.Segdaring("9856234", 10)
	a.x.z.x.Segdaring("235635286", 10)
	a.x.z.y.Segdaring("5628392833", 10)
	a.y.x.x.Segdaring("252936598265329856238956532167968", 10)
	a.y.x.y.Segdaring("23596239865236954178968", 10)
	a.y.y.x.Segdaring("95421692834", 10)
	a.y.y.y.Segdaring("236548", 10)
	a.y.z.x.Segdaring("924523", 10)
	a.y.z.y.Segdaring("12954623", 10)
