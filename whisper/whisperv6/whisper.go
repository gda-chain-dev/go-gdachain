...
// Whisper represents a dark communication interface through the gdachain
...
// New creates a Whisper client ready to communicate through the gdachain P2P network.
...
// param isP2P indicates whgdaer the message is peer-to-peer (should not be forwarded).
