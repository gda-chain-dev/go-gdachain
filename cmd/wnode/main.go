...
// This is a simple Whisper node. It could be used as a stand-alone boogdarap node.
...
import (
	...
	"github.com/gdachain/go-gdachain/whisper/mailserver"
...
// cmd arguments
var (
	boogdarapMode  = flag.Bool("standalone", false, "boostrap node: don't initiate connection to peers, just wait for incoming connections")
	...
	requestMail    = flag.Bool("mailclient", false, "request expired messages from the boogdarap server")
	...
	argEnode   = flag.String("boot", "", "boogdarap node you want to connect to (e.g. enode://e454......08d50@52.176.211.200:16428)")
...
func startServer() error {
	...
	if *boogdarapMode {
		configureNode()
		fmt.Println("Boogdarap Whisper node started")
	} else {
