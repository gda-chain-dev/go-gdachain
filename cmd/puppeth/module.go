...
// returned from docker inspect, parsed into a form easily usable by puppgda.
type containerInfos struct {
	running bool              // Flag whgdaer the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whgdaer there's a container running for the service
	...
	// Infos retrieved, parse the above into somgdaing meaningful
