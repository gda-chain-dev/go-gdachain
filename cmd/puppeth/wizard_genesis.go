...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 1. gdaash - proof-of-work")
	...
	case choice == "1":
		...
		genesis.Config.gdaash = new(params.gdaashConfig)
...
func (w *wizard) manageGenesis() {
	// Figure out whgdaer to modify or export the genesis
	fmt.Println()
	...
	case choice == "2":
		...
		if err := ioutil.WriteFile(w.readDefaulgdaring(fmt.Sprintf("%s.json", w.network)), out, 0644); err != nil {
