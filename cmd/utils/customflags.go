...
// e.g. ~/.gdaereum -> /home/username/.gdaereum
...
func (self DirectoryFlag) String() string {
	...
	return fmt.Sprintf(fmgdaring, prefixedNames(self.Name), self.Value.Value, self.Usage)
}
...
func (f BigFlag) String() string {
	...
	return fmt.Sprintf(fmgdaring, prefixedNames(f.Name), f.Value, f.Usage)
}
