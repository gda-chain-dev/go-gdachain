...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "gda", "shh")
	cfg.WSModules = append(cfg.WSModules, "gda", "shh")
	cfg.IPCPath = "ggda.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, ggdaConfig) {
	// Load defaults.
	cfg := ggdaConfig{
		gda:       gda.DefaultConfig,
	...
	utils.SetgdaConfig(ctx, stack, &cfg.gda)
...
func makeFullNode(ctx *cli.Context) *node.Node {
	...
	utils.RegistergdaService(stack, &cfg.gda)
