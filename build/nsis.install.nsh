Name "ggda ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/gdachain/go-gdachain/issues"
!define UPDATEURL "https://github.com/gdachain/go-gdachain/releases"
!define ABOUTURL "https://github.com/gdachain/go-gdachain#gdaereum-go"
...
# Install ggda binary
Section "Ggda" Ggda_IDX
  SetOutPath $INSTDIR
  file {{.Ggda}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ggda.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\ggda.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Ggda incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Ggda outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Ggda UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Ggda incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\ggda.exe" "" "" "gdachain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Ggda outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\ggda.exe" "" "" "gdachain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Ggda UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\ggda.exe" "" "" "gdachain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/gdaereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "gdaEREUM_SOCKET" "R" "HKLM" "\\.\pipe\ggda.ipc"
  ${EnvVarUpdate} $0 "gdaEREUM_SOCKET" "A" "HKLM" "\\.\pipe\ggda.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${Ggda_IDX}
    SectionGetSize ${Ggda_IDX} $0
