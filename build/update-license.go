...
Please review the resulting diff to check whgdaer the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-gdaereum authors for copyright purposes.\n\n"
)
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-gdaereum library"
	}
	return "the go-gdaereum library"
}
