...
# 1. install ggda for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ggda
# 5. create ggda, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable gdaEREUM_SOCKET
...
!define GROUPNAME "gdachain"
!define APPNAME "Ggda"
!define DESCRIPTION "Official Go implementation of the gdachain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ggda is installed global
