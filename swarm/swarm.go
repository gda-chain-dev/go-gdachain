...
import (
	...
	"github.com/gdachain/go-gdachain/contracts/chequebook"
	"github.com/gdachain/go-gdachain/contracts/ens"
	...
	"github.com/gdachain/go-gdachain/swarm/api"
	httpapi "github.com/gdachain/go-gdachain/swarm/api/http"
	"github.com/gdachain/go-gdachain/swarm/fuse"
	"github.com/gdachain/go-gdachain/swarm/network"
	"github.com/gdachain/go-gdachain/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, config *api.Config) (self *Swarm, err error) {
	...
	self.storage = storage.NewNegdaore(hash, self.lstore, self.cloud, config.StoreParams)
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config) (*ens.ENS, error) {
	...
	ensClient := gdaclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := gdaclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
