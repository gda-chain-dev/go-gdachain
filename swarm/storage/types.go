...
import (
	...
	"github.com/gdachain/go-gdachain/bmt"
...
func newRequesgdaatus(key Key) *Requesgdaatus {
	return &Requesgdaatus{
		Key:        key,
...
- Negdaore: cloud storage abstraction layer
