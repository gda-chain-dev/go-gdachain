...
import (
	...
	ggdametrics "github.com/gdachain/go-gdachain/metrics"
	"github.com/gdachain/go-gdachain/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if ggdametrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(ggdametrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
