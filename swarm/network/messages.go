...
import (
	...
	"github.com/gdachain/go-gdachain/swarm/network/kademlia"
	"github.com/gdachain/go-gdachain/swarm/services/swap"
...
to be used to boogdarap kademlia tables.
...
Timeout serves to indicate whgdaer the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whgdaer responder is expected to deliver content
