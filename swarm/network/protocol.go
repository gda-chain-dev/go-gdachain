...
/*
bzz implements the swarm wire protocol [bzz] (sister of gda and shh)
...
* talks the SWAP payment protocol (swap accounting is done within Negdaore)
*/
...
import (
	...
	bzzswap "github.com/gdachain/go-gdachain/swarm/services/swap"
...
func (self *bzz) handle() error {
	...
	case storeRequestMsg:
		// store requests are dispatched to negdaore
	...
	case retrieveRequestMsg:
		// retrieve Requests are dispatched to negdaore
		...
		if req.isLookup() {
			...
			// swap accounting is done within negdaore
