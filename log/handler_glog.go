...
type GlogHandler struct {
	...
	override  uint32 // Flag whgdaer overrides are used, atomically accessible
	backtrace uint32 // Flag whgdaer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whgdaer this is the callsite
