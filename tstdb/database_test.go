...
func newTestLDB() (*gdadb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "gdadb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := gdadb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db gdadb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db gdadb.Database, t *testing.T) {
	const n = 8
