...
func makeHeaderChain(parent *types.Header, n int, db gdadb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (gdadb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() gdadb.Database {
	return odr.db
}
