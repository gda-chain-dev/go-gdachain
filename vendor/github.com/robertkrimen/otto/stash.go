...
type _objecgdaash struct {
	_runtime *_runtime
	_outer   _stash
	object   *_object
}

func (self *_objecgdaash) runtime() *_runtime {
	return self._runtime
}

func (runtime *_runtime) newObjecgdaash(object *_object, outer _stash) *_objecgdaash {
	if object == nil {
...
func (in *_objecgdaash) clone(clone *_clone) _stash {
	out, exists := clone.objecgdaash(in)
	if exists {
		return out
	}
	*out = _objecgdaash{
...
func (self *_objecgdaash) hasBinding(name string) bool {
	return self.object.hasProperty(name)
}

func (self *_objecgdaash) createBinding(name string, deletable bool, value Value) {
...
func (self *_objecgdaash) setBinding(name string, value Value, strict bool) {
	self.object.put(name, value, strict)
}

func (self *_objecgdaash) setValue(name string, value Value, throw bool) {
...
func (self *_objecgdaash) getBinding(name string, throw bool) Value {
	if self.object.hasProperty(name) {
...
func (self *_objecgdaash) deleteBinding(name string) bool {
	return self.object.delete(name, false)
}

func (self *_objecgdaash) outer() _stash {
	return self._outer
}

func (self *_objecgdaash) newReference(name string, strict bool, at _at) _reference {
...
func gegdaashProperties(stash _stash) (keys []string) {
