...
type _clone struct {
	...
	_objecgdaash map[*_objecgdaash]*_objecgdaash
...
func (clone *_clone) objecgdaash(in *_objecgdaash) (*_objecgdaash, bool) {
	if out, exists := clone._objecgdaash[in]; exists {
		return out, true
	}
	out := &_objecgdaash{}
	clone._objecgdaash[in] = out
	return out, false
}
