...
// Gegdaring returns the string value for a string key.
func (a Tags) Gegdaring(key string) string {
...
// Segdaring sets the string value for a string key.
func (a *Tags) Segdaring(key, value string) {
