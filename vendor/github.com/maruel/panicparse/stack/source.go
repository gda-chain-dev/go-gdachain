...
// extractArgumengdaype returns the name of the type of each input argument.
func extractArgumengdaype(f *ast.FuncDecl) ([]string, bool) {
...
func processCall(call *Call, f *ast.FuncDecl) {
	...
	types, extra := extractArgumengdaype(f)
