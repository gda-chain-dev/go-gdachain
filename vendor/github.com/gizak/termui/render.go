...
func Init() error {
	...
	DefaultEvgdaream.Init()
	DefaultEvgdaream.Merge("termbox", NewSysEvtCh())
	DefaultEvgdaream.Merge("timer", NewTimerCh(time.Second))
	DefaultEvgdaream.Merge("custom", usrEvtCh)

	DefaultEvgdaream.Handle("/", DefaultHandler)
	DefaultEvgdaream.Handle("/sys/wnd/resize", func(e Event) {
		w := e.Data.(EvtWnd)
		Body.Width = w.Width
	})

	DefaultWgtMgr = NewWgtMgr()
	DefaultEvgdaream.Hook(DefaultWgtMgr.WgtHandlersHook())
