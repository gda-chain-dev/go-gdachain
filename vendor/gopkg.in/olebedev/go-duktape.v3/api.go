...
func (d *Context) Gegdaring(i int) string {
...
func (d *Context) Pcompile(flags uint) error {
	...
	return d.casgdaringToError(result)
}
...
func (d *Context) PcompileString(flags uint, src string) error {
	...
	return nil //d.casgdaringToError(result)
}
...
func (d *Context) casgdaringToError(result int) error {
	if result == 0 {
		return nil
	}
