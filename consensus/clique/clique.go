...
var (
	...
	// errInvalidVote is returned if a nonce value is somgdaing else that the two
...
// ecrecover extracts the gdachain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the gdachain address
...
// gdachain testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     gdadb.Database       // Database to store and retrieve snapshot checkpoints
...
func New(config *params.CliqueConfig, db gdadb.Database) *Clique {
...
// Author implements consensus.Engine, returning the gdachain address recovered
...
// verifyHeader checks whgdaer a header conforms to the consensus rules.The
...
// VerifySeal implements consensus.Engine, checking whgdaer the signature contained
// in the header satisfies the consensus protocol requirements.
func (c *Clique) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
	return c.verifySeal(chain, header, nil)
}

// verifySeal checks whgdaer the signature contained in the header satisfies the
