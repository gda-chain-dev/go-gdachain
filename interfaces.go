...
// Package gdaereum defines interfaces for interacting with gdachain.
package gdaereum
...
type TransactionReader interface {
	...
	// blockchain. The isPending return value indicates whgdaer the transaction has been
