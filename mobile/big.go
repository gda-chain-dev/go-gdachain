...
// Segdaring sets the big int to x.
//
...
func (bi *BigInt) Segdaring(x string, base int) {
	bi.bigint.Segdaring(x, base)
}
...
// Gegdaring returns the value of x as a formatted string in some number base.
func (bi *BigInt) Gegdaring(base int) string {
