...
// Transaction represents a single gdachain transaction.
...
// Deprecated: use gdachainClient.TransactionSender
...
func (r *Receipt) GetPosgdaate() []byte         { return r.receipt.Posgdaate }
