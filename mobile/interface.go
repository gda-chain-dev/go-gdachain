...
func (i *Interface) Segdaring(str string)          { i.object = &str }
func (i *Interface) Segdarings(strs *Strings)      { i.object = &strs.strs }
...
func (i *Interface) SetDefaulgdaring()    { i.object = new(string) }
func (i *Interface) SetDefaulgdarings()   { i.object = new([]string) }
...
func (i *Interface) Gegdaring() string        { return *i.object.(*string) }
func (i *Interface) Gegdarings() *Strings     { return &Strings{*i.object.(*[]string)} }
