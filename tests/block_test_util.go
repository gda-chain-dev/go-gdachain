...
// Package tests implements execution of gdachain JSON tests.
package tests
...
type btJSON struct {
	...
	Post      core.GenesisAlloc     `json:"posgdaate"`
...
func (t *BlockTest) Run() error {
	...
	if err = t.validatePosgdaate(newDB); err != nil {
...
/* See https://github.com/gdaereum/tests/wiki/Blockchain-Tests-II

   Whgdaer a block is valid or not is a bit subtle, it's defined by presence of
...
func (t *BlockTest) validatePosgdaate(statedb *state.StateDB) error {
