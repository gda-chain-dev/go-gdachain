...
// See https://github.com/gdaereum/EIPs/issues/176 for the test format specification.
...
type stJSON struct {
	...
	Post map[string][]stPosgdaate `json:"post"`
}

type stPosgdaate struct {
...
func MakePreState(db gdadb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPosgdaate) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/gdaereum/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
