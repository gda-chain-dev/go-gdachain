...
type DatabaseReader interface {
	...
	// Has retrieves whgdaer a key is present in the database.
...
type Database struct {
	diskdb gdadb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb gdadb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch gdadb.Batch) error {
	// If the node does not exist, it's a previously committed node
