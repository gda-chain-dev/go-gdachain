...
import (
	...
	"github.com/gdachain/go-gdachain/p2p/simulations/adapters"
)
...
// starting nodes and connecting them toggdaer.
//
...
// Connect connects two nodes toggdaer by calling the "admin_addPeer" RPC
...
// NOTE:
// it also checks whgdaer there has been recent attempt to connect the peers
...
type Node struct {
	...
	// Up tracks whgdaer or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whgdaer or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whgdaer both nodes are currently up
