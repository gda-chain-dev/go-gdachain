...
// Contains reports whgdaer the given IP is contained in the list.
...
// IsLAN reports whgdaer an IP is a local network address.
...
// IsSpecialNetwork reports whgdaer an IP is located in a special-use network range
...
// CheckRelayIP reports whgdaer an IP relayed from the given sender IP
...
// SameNet reports whgdaer two IP addresses have an equal prefix of the given bit length.
...
// Contains whgdaer the given IP is contained in the set.
