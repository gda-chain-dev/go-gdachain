...
func TestDialStateStaticDial(t *testing.T) {
	...
	runDialTest(t, dialtest{
		init: newDialState(wangdaatic, nil, fakeTable{}, 0, nil),
		rounds: []round{
			...
			// irrespective whgdaer it was originally static or dynamic.
			{
				peers: []*Peer{
					{rw: &conn{flags: dynDialedConn, id: uintID(1)}},
					{rw: &conn{flags: staticDialedConn, id: uintID(3)}},
...
func (t *resolveMock) Boogdarap([]*discover.Node)               {}
