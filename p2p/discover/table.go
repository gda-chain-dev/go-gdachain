...
// isInitDone returns whgdaer the table's initial seeding procedure has completed.
...
func (tab *Table) lookup(targetID NodeID, refreshIfEmpty bool) []*Node {
	...
	for {
		...
		// first query will hit this case and run the boogdarapping
		// logic.
		<-tab.refresh()
...
// boogdarap or discarded faulty peers).
